...
describe('Cases from app.js', () => { // this is a testing suite made up of suites.
  ...
  describe('Ben', () => {
    ...
    it('should have favBand equal Beastie Boys', () => {
      const Ben = cases.Ben;
      expect(Ben.favBand).to.equal('Beastie Boys');
    });
  });
  ...
  describe('Sean', () => {
    ...
    it('should have favFood equal Pizza', () => {
      const Sean = cases.Sean;
      expect(Sean.favFood).to.equal('Pizza');
    });
  });
  ...
  describe('Ryan', () => {
    ...
    it('should have favBook not equal Harry Potter', () => {
      const Ryan = cases.Ryan;
      expect(Ryan.favBook).to.not.equal('Harry Potter');
    });
  });
  ...
  describe('Austen', () => {
    ...
    it('should have favColor not equal Gold', () => {
      const Austen = cases.Austen;
  ...
  describe('Karthik', () => {
    ...
    it('should have favActivity equal Rock Climbing', () => {
      const Karthik = cases.Karthik;
  ...
  describe('addNums', () => {
    ...
    it('addNums(5, 5) should equal 10', () => {
      const addNums = cases.addNums;
  ...
  describe('iterator', () => {
    ...
    it('should call a callback for n times passed to cases.iterator', () => {
      const cb = sinon.spy();
      const cbInvoker = cases.iterator;
      const num = 'four';
      cbInvoker(num, cb);
